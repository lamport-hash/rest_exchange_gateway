# REST Exchange Gateway — Project Specification
...
- Maintains correct order state under failure, retries, and restarts
...
- Implement authentication or key management securely. You can discuss about secure implementation though.
...
|---|---|---|
| 1 | Source code | — |
| 2 | README | Overall architecture; common order schema; adapter design (OKX vs Binance); idempotency and retry strategy; trade-offs and known limitations |
| 3 | Tests | Unit tests for the order state machine; a small number of integration-style tests (or test harness) |
| 4 | Example usage | Script or curl examples placing, canceling, and amending orders on both venues |
...
- WebSocket endpoints in addition to REST
